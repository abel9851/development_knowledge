...
- 집중력
	- 공식문서의 영어가 이해가 한번에 안되더라도 속으로 읽으면서 끝까지 읽어본다.
	- 작업할 때 아무 생각없이 키보드를 치지말고 다음 동작할 때 손이 자동으로 안따라준다면 순서를 머리속으로 일단 떠올려 본 다음, 움직인다.
		- 여유를 가져라, 조급해 할 필요 없다. 조급해하면 습득이 안된다. 여유를 갖는게 가장 빠르다.
- `Arg::with_name`을 사용해봤다. 파라미터를 정의하는 메소드다.



#rust #2026년 #6월 #24일 #25일 #26일 #27일 #28일